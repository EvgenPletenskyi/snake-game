...
class Game {
    ...
    spawnWall() {
        ...
        const wallGraphic = this.wall.drawWall(wallPosition.x, wallPosition.y, 0xa96a0e);
    ...
    getNextFoodPosition(currentFoodPosition) {
        return this.food.positions.find(position =>
            position.x !== currentFoodPosition.x || position.y !== currentFoodPosition.y
        );
    }
    ...
    drawWalls() {
        for (let x = 0; x < this.gridSize; x++) {
            ...
            this.gameContainer.addChild(this.wall.drawWall( x, this.gridSize - 1, 0xa96a0e ));
        }

        for (let y = 1; y < this.gridSize - 1; y++) {
            this.gameContainer.addChild(this.wall.drawWall( 0, y, 0xa96a0e));
            this.gameContainer.addChild(this.wall.drawWall( this.gridSize - 1, y, 0xa96a0e));
        }
    }
